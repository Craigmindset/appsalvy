          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 items-start mb-16">
            ...
            <div className="lg:col-span-3">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                {/* Mission Card */}
                <div className="p-8 rounded-xl bg-red-50 dark:bg-card border border-border hover:border-primary/50 transition-all hover:shadow-lg">
                ...
                {/* Vision Card */}
                <div className="p-8 rounded-xl bg-white dark:bg-card border border-border hover:border-primary/50 transition-all hover:shadow-lg">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-12 h-12 rounded-lg bg-primary/10 dark:bg-primary/20 flex items-center justify-center">
              ...
              {/* Values Section */}
              <div>
                <h3 className="text-2xl font-bold text-destructive text-center mb-4">
                  Our Values
                </h3>
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                  {VALUES.map((value) => {
                    ...
                    return (
                      <div
                        key={value.id}
                        className="p-4 rounded-lg bg-background dark:bg-card border border-border hover:border-primary/50 transition-all text-center"
                      >
